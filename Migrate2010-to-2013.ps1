...
################################################################
#  Create Web Application and later remove the Sharepoint Content Database
Measure-Command {
...
#################################################################
#  Start SharePoint Content DB Migration Process
#################################################################
...
# Step 2 = Attach and upgrade the 2010 SharePoint Content Databse
Measure-Command {
...
# Dismount the temporary content database when the web application was created
...
#        - Unlock site collection - sometimes locked during migration
#################################################################
...
# Note Time:  120 min 48 sec  

#################################################################
#  Begin Project Server 2010 to 2013 migration
#################################################################
# Step 1 - Creates a new ProjectWebApp 2013 Database 
Measure-Command {
...
#################################################################
# Step 2 - Attach ProjectWebApp 2913 DB to Web Application
Measure-Command {
...
#################################################################
# Step 3 - Check ProjectWebApp DB for issues
