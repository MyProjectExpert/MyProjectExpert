...
$PassPhrase               = "Wcc2wcc299"
#
$DatabaseServer           = "msi2017sql"
$CentralAdminSite         = "http://msi2019farm2:8080"
#
$AcctFarmAdmin            = "wcc2prod\mawharton"
$AcctFarmAdmin            = "wcc2prod\AdminFarm"
$farmPass                 = "Wcc2wcc299"
...
$AcctServiceSP            = "wcc2prod\ServiceSP"
$servicePass              = "Wcc2wcc299"
...
# Notes for removing State Service Application
# Get-SPStateServiceDatabase
# Remove-SPStateServiceDatabase -IDENTITY f05d033c-42d7-4cd4-8db4-dae21301622e 
# $DBID=  Get-SPStateServiceDatabase
# Remove-SPStateServiceDatabase -IDENTITY DBID

#get-help project | Sort-Object name
