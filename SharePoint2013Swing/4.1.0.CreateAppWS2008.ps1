<#
    ...
    .DESCRIPTION
        Create IaaS Windows Server 2008 R2 VM
        and then install SharePoint 2013 and Project Server 2013
    .AUTHOR
        Michael Wharton
    .DATE
        01/19/2019
...
#
$groupName        = "appws2008"
$vmName           = "appws2008"          #  using SharePoint 2019 trial as Active Directory
$storageName      = "appws2008storage"   # NOTE: must be lowercase 
$OSDiskName       = "appws2008OS" 
$DataDiskName     = "appws2008data1" 
$PIPname          = "appws2008pip"
$NICname          = "appws2008nic"
#
