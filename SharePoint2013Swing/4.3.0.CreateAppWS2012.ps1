<#
    ...
    .DESCRIPTION
        Create SharePoint 2013 using Trial SharePoint 2013 on Windows 2012 datacenter
    .AUTHOR
        Michael Wharton
    .DATE
        01/19/2019
...
#
$groupName        = "appws2012"
$vmName           = "appws2012"          #  using SharePoint 2019 trial as Active Directory
$storageName      = "appws2012storage"   # NOTE: must be lowercase 
$OSDiskName       = "appws2012OS" 
$DataDiskName     = "appws2012data1" 
$PIPname          = "appws2012pip"
$NICname          = "appws2012nic"
#
