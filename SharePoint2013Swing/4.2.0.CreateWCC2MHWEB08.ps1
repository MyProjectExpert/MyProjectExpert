...
#
$groupName        = "wcc2mhweb08"
$vmName           = "wcc2mhweb08"          #  using SharePoint 2019 trial as Active Directory
$storageName      = "wcc2mhweb08storage"   # NOTE: must be lowercase 
$OSDiskName       = "wcc2mhweb08OS" 
$DataDiskName     = "wcc2mhweb08data1" 
$PIPname          = "wcc2mhweb08pip"
$NICname          = "wcc2mhweb08nic"
#
