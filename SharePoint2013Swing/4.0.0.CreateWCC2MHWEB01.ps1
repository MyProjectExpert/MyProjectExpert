...
#
$groupName        = "wcc2mhweb01"
$vmName           = "wcc2mhweb01"          #  using SharePoint 2019 trial as Active Directory
$storageName      = "wcc2mhweb01storage"   # NOTE: must be lowercase 
$OSDiskName       = "wcc2mhweb01OS" 
$DataDiskName     = "wcc2mhweb01data1" 
$PIPname          = "wcc2mhweb01pip"
$NICname          = "wcc2mhweb01nic"
#
