...
#
$groupName        = "wcc2mhapp01"
$vmName           = "wcc2mhapp01"          #  using SharePoint 2019 trial as Active Directory
$storageName      = "wcc2mhapp01storage"   # NOTE: must be lowercase 
$OSDiskName       = "wcc2mhapp01OS" 
$DataDiskName     = "wcc2mhapp01data1" 
$PIPname          = "wcc2mhapp01pip"
$NICname          = "wcc2mhapp01nic"
#
