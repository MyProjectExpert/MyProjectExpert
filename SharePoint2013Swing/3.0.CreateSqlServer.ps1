<#
    ...
    .DESCRIPTION
        demosql  - Windows 2008RS SharePoint version
    .AUTHOR
        Michael Wharton
    .DATE
        01/19/2019
...
#
#                 prefex name to be unique 
$groupName        = "demosql"
$vmName           = "demosql"          #  using SharePoint 2019 trial as Active Directory
$storageName      = "demosqlstorage"   # NOTE: must be lowercase 
$OSDiskName       = "demosqlOS" 
$DataDiskName     = "demosqldata1" 
$PIPname          = "demosqlpip"
$NICname          = "demosqlnic"
#
