<#
    ...
    .DESCRIPTION
        wcc2mhsql  - Windows 2008RS SharePoint version
    .AUTHOR
        Michael Wharton
    .DATE
        01/19/2019
...
#
$groupName        = "wcc2mhsql"
$vmName           = "wcc2mhsql"          #  using SharePoint 2019 trial as Active Directory
$storageName      = "wcc2mhsqlstorage"   # NOTE: must be lowercase 
$OSDiskName       = "wcc2mhsqlOS" 
$DataDiskName     = "wcc2mhsqldata1" 
$PIPname          = "wcc2mhsqlpip"
$NICname          = "wcc2mhsqlnic"
#
