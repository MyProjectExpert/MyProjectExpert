...
#
$groupName        = "wcc2mhapp08"
$vmName           = "wcc2mhapp08"          #  using SharePoint 2019 trial as Active Directory
$storageName      = "wcc2mhapp08storage"   # NOTE: must be lowercase 
$OSDiskName       = "wcc2mhapp08OS" 
$DataDiskName     = "wcc2mhapp08data1" 
$PIPname          = "wcc2mhapp08pip"
$NICname          = "wcc2mhapp08nic"
#
