<#
    ...
    .DESCRIPTION
        Create SharePoint 2013 Trial on Windows Server 2012
    .AUTHOR
        Michael Wharton
    .DATE
        01/19/2019
...
#
$groupName        = "webws2012"
$vmName           = "webws2012"          #  using SharePoint 2019 trial as Active Directory
$storageName      = "webws2012storage"   # NOTE: must be lowercase 
$OSDiskName       = "webws2012OS" 
$DataDiskName     = "webws2012data1" 
$PIPname          = "webws2012pip"
$NICname          = "webws2012nic"
#
